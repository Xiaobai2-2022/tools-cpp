# auth: University of Waterloo Department of Software Engineering
# changed by: Zhifan (Xiaobai2)
#!/bin/bash

# files might have Windows/Mac line endings
# outputs might have noeol on last line etc.
